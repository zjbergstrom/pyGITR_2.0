...
x1,x2,x3,y1,y2,y3,z1,z2,z3,\
    area,surf,Z,materialSurfaceInidces,surfIndArray,\
        a,b,c,d,in_direction,plane_norm = getGeom(GeomFile)
...
ncFile = netCDF4.Dataset('../input/surface_evolution_C_W.nc', 'w', format='NETCDF4')
...
# COLLECT ONLY THE SURFACES WITH PARTICLES
# particleSourceDict = {}
# for surface_index in range(len(x1)): # AND IF SURFACE = 1?
#     numZ = {}
#     for z in Zs:
#         if z == 6:
...
particleSourceDict = {}
for surface_index in surfacehit_C: # AND IF SURFACE = 1?
    if surface_index!=-1:
        numZ = {}
        # for z in Zs:
        #     if z == 6:
        ...
        #         print("Wait a minute!!!")
        # particleSourceDict[surface_index] = numZ
        print(Gamma_C_ero_global[surface_index]*Delta_t_gitr*area[surface_index]/prop_C)
